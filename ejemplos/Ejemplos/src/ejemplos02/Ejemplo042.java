...
public class Ejemplo042 {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < arreglo1.length; i++) {
            ...
            //coloque otro arreglo que aparte de mulplicar me sume las tres 
            //respuestas con la ayuda de otro for y colocarle una funcion
            //obtenerSuma y luego llamarla en obtenerReporte para que presente 
            }
        }
